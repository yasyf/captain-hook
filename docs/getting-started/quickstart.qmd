...
- [Patterns](../guide/patterns.qmd) — real-world hooks from a production hooks directory
- [How It Works](how-it-works.qmd) — understand the lifecycle and dispatch pipeline
- [Primitives](../guide/primitives.qmd) — explore all built-in hook primitives
- [Conditions](../guide/conditions.qmd) — filter when hooks fire
- [Testing](../guide/testing.qmd) — test your hooks with inline tests and mock events
