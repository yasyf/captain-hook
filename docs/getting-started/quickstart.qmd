...
The formula fills the Cellar; `helper install` deploys `~/Applications/Captain Hook.app` from it
and verifies the host answers. The helper embedded in that exact path owns
