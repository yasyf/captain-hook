...
The plugin and app are one exact release unit. If their versions differ, the host rejects the
event before dispatch. Upgrade the cask and plugin together; captain-hook never substitutes an
older protocol, starts a private daemon, or reruns the event cold.
