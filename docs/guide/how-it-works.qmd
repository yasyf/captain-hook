...
Claude Code fires eleven events in total. For when each one fires, the event class it carries, and whether it can block, see [the events reference](../reference/events.qmd).
