...
For hooks that depend on transcript context, use `TranscriptFixture`. The message shape is
Claude Code JSONL: `{"type": "assistant", "message": {"content": [<tool_use blocks>]}}`:
