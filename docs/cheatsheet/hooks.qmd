...
- How-tos: [Deterministic primitives](../guide/primitives.qmd) · [LLM hooks](../guide/llm-hooks.qmd) · [Filter with conditions](../guide/primitives.qmd#filter-with-conditions)
