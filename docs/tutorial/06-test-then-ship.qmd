...
Every preset you clicked in this tutorial is a test case, and hooks carry their tests inline. Here's page one's guard again — this time with its `tests`:

<!-- gd-embed-fragment: tutorial_first_block_tested -->
