...
Commands are one attack surface. Files are the other: an agent that writes `TOKEN=sk-live-...` into `.env` has just committed your secret to its transcript. This guard watches for exactly that — and nothing else:

<!-- gd-embed-fragment: tutorial_secret_guard -->

Three conditions, one veto. Pick a tool, a path, and file content, and see which combination fires:
