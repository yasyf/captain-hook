...
- **The inspiration** — where this came from, and why steering agents belongs in tested hooks instead of prompts — [check out the blog post](https://yasyf.com/writing/less-prompts-more-guardrails)
